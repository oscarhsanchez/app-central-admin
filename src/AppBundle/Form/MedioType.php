...
class MedioType extends ESocialType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('estatus_iluminacion', null, array('label' => 'form.medio.label.estatus_iluminacion', 'attr' => array('maxlength' => 6)));
        $builder->add('visibilidad', null, array('label' => 'form.medio.label.estatus_iluminacion', 'attr' => array('maxlength' => 10)));
