...
## Permissions
set :writable_dirs,       ["app/cache", "app/logs", "web/media", "web/uploads/temp", "tmp"]
...
namespace :rb do
    ...
    task :permissions do
        ...
        run "chmod -R 777 #{latest_release}/web/uploads/temp"
        capifony_puts_ok
    end
...
set :shared_children,     [app_path + "/logs", web_path + "/media", web_path + "/uploads/temp", "tmp"]
